...
@section('content')
    ...
    <div class="container-fluid p-4 p-lg-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0">{{ __('Create Branch') }}</h1>
                <p class="text-muted mb-0">{{ __('Add a new branch for a vendor') }}</p>
            </div>
            <div>
                        ...
                        <form action="{{ route('admin.branches.store') }}" method="POST" enctype="multipart/form-data" id="branchForm">
                            ...
                            <div class="d-flex gap-2 mt-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-check-lg me-2"></i>{{ __('Create Branch') }}
                                </button>
...
@push('scripts')
<script>
// Optional: Add map picker functionality here if needed
