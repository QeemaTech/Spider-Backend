    ...
    <div class="container-fluid p-4 p-lg-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                ...
                <button type="button" class="btn btn-danger delete-branch-btn"
            ...
            <div class="col-lg-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label class="form-label text-muted">{{ __('Vendor') }}</label>
                                <p class="mb-0">
                                    @if($branch->vendor)
            ...
            <div class="col-lg-4">
                ...
                @if($branch->vendor)
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <p class="mb-2">
                                <strong>{{ $branch->vendor->getTranslation('name', app()->getLocale()) }}</strong>
                            </p>
                            @if($branch->vendor->phone)
                                <p class="mb-2">
                                    <i class="bi bi-telephone me-1"></i>
                                    <a href="tel:{{ $branch->vendor->phone }}" class="text-decoration-none">
                                        {{ $branch->vendor->phone }}
                                    </a>
                                </p>
                            @endif
                            <a href="{{ route('admin.vendors.show', $branch->vendor) }}" class="btn btn-sm btn-outline-primary">
                                <i class="bi bi-eye me-1"></i>{{ __('View Vendor') }}
                            </a>
                        </div>
                    </div>
                @endif
