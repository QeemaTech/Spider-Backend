...
@section('content')
    ...
    <div class="container-fluid p-4 p-lg-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0">{{ __('Add Branch') }}</h1>
                <p class="text-muted mb-0">{{ __('Add a new branch to your business') }}</p>
            </div>
            <div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('vendor.branches.store') }}" method="POST" enctype="multipart/form-data" id="branchForm">
                            @csrf
                            ...
                            <div class="d-flex gap-2 mt-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-check-lg me-2"></i>{{ __('Add Branch') }}
                                </button>
